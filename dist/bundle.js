/******/ (function(modules) {
  ...
  /******/ /******/ return __webpack_require__(
    (__webpack_require__.s = "./src/app.ts")
  );
  /******/
})(
  /************************************************************************/
  ...
  \********************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _lib_PigLatinConverter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          /*! ./lib/PigLatinConverter */ "./src/lib/PigLatinConverter.ts"
        );
        ...
        submit.addEventListener("click", function() {
          return (output.value = new _lib_PigLatinConverter__WEBPACK_IMPORTED_MODULE_0__[
            "default"
          ](input.value).getConvertedText());
        });
  ...
  \**************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        var PigLatinConverter = /** @class */ (function() {
           ...
           */
          PigLatinConverter.prototype.capitalization = function(
            original,
            parsed
          ) {
           ...
           */
          PigLatinConverter.prototype.fixPunctuation = function(
            original,
            parsed
          ) {
            ...
            lettersOriginal
              .slice(0)
              .reverse()
              .map(function(character, positionFromEnd) {
